...
class EcsMicroserviceStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        vpc = ec2.Vpc(
            self, "MyVpc",
            max_azs=2
            #default is cidr="10.0.0.0/16"
        )
        
        self.rdsInst = rds.DatabaseInstance(self, 'SpringPetclinicDB',
        ...
        self.rdsInst.connections.allow_default_port_from_any_ipv4()
        ...
        default_vpc_subnets = vpc.select_subnets(subnet_type=ec2.SubnetType.PUBLIC)
        ...
        for s in ['customers', 'vets', 'visits', 'static']:
            ...
            if s != 'static':
                env = {
                  ...
                  'SPRING_DATASOURCE_URL': 'jdbc:mysql://' + self.rdsInst.db_instance_endpoint_address + '/petclinic?useUnicode=true',
